//
//  PostEditSuccessViewController.m
//  RealEstate
//
...
@interface PostEditSuccessViewController ()

@end

@implementation PostEditSuccessViewController
...
- (IBAction)getAdPostedBtnPressed:(id)sender {
    ...
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://itunes.apple.com/us/app/friends-birthdaymessages/id867860381?ls=1&mt=8"]];
}
