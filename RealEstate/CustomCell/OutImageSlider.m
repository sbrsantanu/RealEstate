...
-(void)setFrame:(CGRect)frame
{
    ...
    [self.imgView setFrame:CGRectMake(40,0,frame.size.width - 80,frame.size.height)];
    ...
    //[self.lblImgNumber setFrame:CGRectMake(frame.size.width - 45,10,45,41)];
    imageRect = CGRectMake(0,0,frame.size.width - 80,frame.size.height);
